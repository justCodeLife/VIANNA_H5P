...
(function () {
        ...
        return {
            define: function (b, d) {
                ...
                if (0 > e.getListenerIndex(d)) {
                    ...
                    m.fn = d;
                    m.priority = g;
                    for (var x = e.length - 1; 0 <= x; x--) if (e[x].priority <= g) return e.splice(x + 1, 0, m), {removeListener: r};
                    e.unshift(m)
                }
            ...
            once: function () {
                ...
                return function (g, m, r) {
                    ...
                    if (e) {
                        var x = e.listeners;
                        if (x.length) for (var x = x.slice(0), B, D = 0; D < x.length; D++) {
                            if (e.errorProof) try {
                                B =
                                    x[D].call(this, r, m, b, k)
                            } catch (w) {
                            } else B = x[D].call(this, r, m, b, k);
    ...
    (function () {
        var a = [], d = CKEDITOR.env.gecko ? "-moz-" : CKEDITOR.env.webkit ? "-webkit-" : CKEDITOR.env.ie ? "-ms-" : "",
            ...
            g = {lt: "\x3c", gt: "\x3e", amp: "\x26", quot: '"', nbsp: " ", shy: "­"}, m = function (a, e) {
        ...
        CKEDITOR.tools = {
            ...
            transformPlainTextToHtml: function (a, e) {
                var b = e == CKEDITOR.ENTER_BR, c = this.htmlEncode(a.replace(/\r\n/g, "\n")),
                    c = c.replace(/\t/g, "\x26nbsp;\x26nbsp; \x26nbsp;"), g = e == CKEDITOR.ENTER_P ? "p" : "div";
                if (!b) {
                    var d = /\n{2}/g;
                    if (d.test(c)) var m = "\x3c" + g + "\x3e", p = "\x3c/" + g + "\x3e",
            ...
            normalizeCssText: function (a, e) {
                var b = [], c, g = CKEDITOR.tools.parseCssText(a, !0, e);
            ...
            keystrokeToArray: function (a, e) {
                var b = e & 16711680, c = e & 65535, g = CKEDITOR.env.mac, d = [], m = [];
                ...
                return {display: d, aria: m}
            },
            transparentImageData: "data:image/gif;base64,R0lGODlhAQABAPABAP///wAAACH5BAEKAAAALAAAAAABAAEAAAICRAEAOw\x3d\x3d",
            getCookie: function (a) {
                a = a.toLowerCase();
                for (var e = document.cookie.split(";"), b, c, g = 0; g < e.length; g++) if (b = e[g].split("\x3d"), c = decodeURIComponent(CKEDITOR.tools.trim(b[0]).toLowerCase()), c === a) return decodeURIComponent(1 < b.length ? b[1] : "");
                return null
            },
            ...
            convertBytesToBase64: function (a) {
                var b = "", c = a.length, g;
                for (g = 0; g < c; g += 3) {
                    var d = a.slice(g, g + 3), m = d.length, f = [], p;
                    if (3 > m) for (p = m; 3 > p; p++) d[p] = 0;
                    f[0] = (d[0] & 252) >> 2;
                    f[1] = (d[0] & 3) << 4 | d[1] >> 4;
            ...
            style: {
                parse: {
                    ...
                    margin: function (a) {
                        ...
                        var c = {}, g = a.match(/(?:\-?[\.\d]+(?:%|\w*)|auto|inherit|initial|unset)/g) || ["0px"];
                        switch (g.length) {
                            case 1:
                                b([0, 0, 0, 0]);
                                break;
        ...
        CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
            ...
            is: function () {
                ...
                if (b.removeProperty || "border" != a && "margin" != a && "padding" != a) b.removeProperty ? b.removeProperty(a) : b.removeAttribute(CKEDITOR.tools.cssStyleToDomStyle(a)), this.$.style.cssText || this.removeAttribute("style"); else {
                    ...
                    for (var b = [], d = 0; d < c.length; d++) if (e) for (var x =
                        0; x < e.length; x++) b.push([a, c[d], e[x]].join("-")); else b.push([a, c[d]].join("-"));
                ...
                var b = 0, c = 0, e = this.getDocument(), d = e.getBody(), x = "BackCompat" == e.$.compatMode;
                if (document.documentElement.getBoundingClientRect && (CKEDITOR.env.ie ?
                    ...
                    var f = this.$.getBoundingClientRect(), h = e.$.documentElement,
                        w = h.clientTop || d.$.clientTop || 0, p = h.clientLeft || d.$.clientLeft || 0, k = !0;
                ...
                } else for (w = this, p = null; w && "body" != w.getName() &&
                "html" != w.getName();) {
                ...
                x = a.getWindow();
                d = w(this, x);
                var u = w(a, x), K = this.$.offsetHeight;
                e = this.$.offsetWidth;
            ...
            getFrameDocument: function () {
                ...
                for (var e = 0; e < c.length; e++) {
                    var d = c[e], x = d.nodeName.toLowerCase(), f;
                    if (!(x in b)) if ("checked" == x && (f = this.getAttribute(x))) a.setAttribute(x, f); else if (!CKEDITOR.env.ie || this.hasAttribute(x)) f = this.getAttribute(x), null === f && (f = d.nodeValue), a.setAttribute(x, f)
                }
                "" !== this.$.style.cssText &&
    ...
    (function () {
        function a(a, b) {
            ...
            e = c.endContainer;
            var f = c.startOffset, y = c.endOffset, h, l = this.guard, q = this.type,
        ...
        var f = /^[\t\r\n ]*(?:&nbsp;|\xa0)$/, h = CKEDITOR.dom.walker.whitespaces(),
            k = CKEDITOR.dom.walker.bookmark(), g = CKEDITOR.dom.walker.temp(), m = function (a) {
    ...
    (function () {
        ...
        function d(a, b, c, d, f) {
            ...
            function p() {
                ...
                for (a = 0; a < e; a++) if (b = O[a], c = n[a], !b.equals(c)) return a;
                return a - 1
            }

            function g() {
                var b = N - 1, c = C && z && !q.equals(F);
            ...
            b = l || r;
            var q = a.startContainer, F = a.endContainer,
                L = a.startOffset, E = a.endOffset, M, t, C, z, H, P;
            if (l && F.type == CKEDITOR.NODE_TEXT && (q.equals(F) || q.type === CKEDITOR.NODE_ELEMENT && q.getFirst().equals(F))) c.append(a.document.createText(F.substring(L, E))); else {
                ...
                G = c;
                for (Q = N; Q <= A; Q++) if (c = n[Q], V = c.getPrevious(), c.equals(O[Q])) b && (G = G.getChild(0)); else {
        ...
        CKEDITOR.dom.range.prototype = {
            clone: function () {
                ...
                function a(b) {
                    var e = b.container, d = b.offset, p;
                    p = e;
                    var f = d;
                    ...
                    if (e.type == CKEDITOR.NODE_ELEMENT && 0 < d) {
                        a:{
                            for (p = e; d--;) if (f = p.getChild(d).getIndex(!0), 0 <= f) {
                                d = f;
                                break a
                            }
                            d = -1
            ...
            trim: function (a, b) {
                ...
                switch (a) {
                    ...
                    case CKEDITOR.ENLARGE_ELEMENT:
                        ...
                        var p = this.getCommonAncestor(), g = this.root, k, r, l, q, F, L = !1, E, M;
                        ...
                        for (l = c(l); l || q;) {
                            ...
                            for (; q;) if (E = !1, q.type == CKEDITOR.NODE_COMMENT) q = q.getPrevious(); else {
                                if (q.type == CKEDITOR.NODE_TEXT) M = q.getText(), d.test(M) && (q = null), E = /[\s\ufeff]$/.test(M); else if ((q.$.offsetWidth > (CKEDITOR.env.webkit ? 1 : 0) || b && q.is("br")) && !q.data("cke-bookmark")) if (L && CKEDITOR.dtd.$removeEmpty[q.getName()]) {
                                    M =
                                        q.getText();
                                    if (d.test(M)) q = null; else for (var t = q.$.getElementsByTagName("*"), C = 0, z; z = t[C++];) if (!CKEDITOR.dtd.$removeEmpty[z.nodeName.toLowerCase()]) {
                                        q = null;
                                        break
                                    }
                                    q && (E = !!M.length)
                        ...
                        for (; l || q;) {
                            ...
                            for (; q;) {
                                E = !1;
                                if (q.type == CKEDITOR.NODE_TEXT) M = q.getText(), h(q, 0) || (q = null), E = /^[\s\ufeff]/.test(M); else if (q.type == CKEDITOR.NODE_ELEMENT) {
                                    if ((0 < q.$.offsetWidth || b && q.is("br")) && !q.data("cke-bookmark")) if (L && CKEDITOR.dtd.$removeEmpty[q.getName()]) {
                                        M =
                                            q.getText();
                                        if (d.test(M)) q = null; else for (t = q.$.getElementsByTagName("*"), C = 0; z = t[C++];) if (!CKEDITOR.dtd.$removeEmpty[z.nodeName.toLowerCase()]) {
                                            q = null;
                                            break
                                        }
                                        q && (E = !!M.length)
                    ...
                    case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
                        ...
                        if (a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS) {
                            l = this.clone();
                            l = new CKEDITOR.dom.walker(l);
                            var v = CKEDITOR.dom.walker.whitespaces(), A = CKEDITOR.dom.walker.bookmark();
                ...
                if (!this.collapsed) {
                    ...
                    var h = new CKEDITOR.dom.walker(h), q = CKEDITOR.dom.walker.bookmark(),
            ...
            fixBlock: function (a, b) {
                ...
                var c = new CKEDITOR.dom.elementPath(this.startContainer, this.root),
                    d = new CKEDITOR.dom.elementPath(this.endContainer, this.root), f = c.block, h = d.block, p = null;
                ...
                var c, d = 0, f, h, p = [CKEDITOR.POSITION_AFTER_END, CKEDITOR.POSITION_BEFORE_START];
            ...
            moveToElementEditEnd: function (a) {
                ...
                var c = this.getCommonAncestor(), d = this.getBoundaryNodes(), f = [], h, p, g, k;
                if (c && c.find) for (p = c.find(a), h = 0; h < p.count(); h++) if (c = p.getItem(h), b || !c.isReadOnly()) g = c.getPosition(d.startNode) & CKEDITOR.POSITION_FOLLOWING || d.startNode.equals(c), k = c.getPosition(d.endNode) & CKEDITOR.POSITION_PRECEDING + CKEDITOR.POSITION_IS_CONTAINED ||
        ...
        a.prototype = {
            getNextParagraph: function (a) {
                ...
                if (!this._.started) {
                    ...
                    k = w.startPath();
                    var p = w.endPath(), J = !w.collapsed && c(w, k.block), u = !w.collapsed && c(w, p.block, 1);
                ...
                for (this._.nextNode = null; p;) {
                    var J = 0, u = p.hasAscendant("pre"), K = p.type != CKEDITOR.NODE_ELEMENT, l = 0;
                    if (K) p.type == CKEDITOR.NODE_TEXT && f.test(p.getText()) && (K = 0); else {
                        ...
                        if (CKEDITOR.dtd.$block[q] && "false" == p.getAttribute("contenteditable")) {
                            ...
                            b(this, a, d);
                            break
                        } else if (p.isBlockBoundary(this.forceBrBreak && !u && {br: 1})) {
                            if ("br" == q) K = 1; else if (!k && !p.getChildCount() && "hr" != q) {
                                d = p;
                                x = p.equals(w);
                                break
                            }
    ...
    (function () {
        function a(a, b, c, d, f) {
            ...
            for (e in b) {
                v = b[e];
                v = "boolean" == typeof v ? {} : "function" == typeof v ? {match: v} : C(v);
                ...
                for (p in P) {
                    l[p] = k(l[p], n) || null;
                    var h = l, q = O[p], t = k(l[O[p]], n), A = l[p], z = [], g = !0, H = void 0;
                    t ? g = !1 : t = {};
        ...
        function c(a, b, c) {
            if (!a.match || a.match(b)) {
                ...
                b = b.classes;
                if (a) {
                    for (var d = !1, e = !0 === a, v = b.length; v--;) if (e || a(b[v])) b.splice(v, 1), d = !0;
                    a = d
                } else a = !1;
        ...
        function B(a, b, f, e) {
            ...
            if (e.doCallbacks && a.elementCallbacks) {
                a:{
                    ...
                    for (var h = 0, t = n.length, C; h < t; ++h) if (C = n[h](b)) {
                        n = C;
                        break a
                    }
                    n = void 0
            ...
            if (e.doFilter) {
                a:{
                    ...
                    if (a || n) {
                        x(b);
                        if (h) for (k = 0, g = h.length; k < g; ++k) if (!1 === c(h[k], b, z)) {
                            a = null;
                            break a
                        }
                        if (t) for (k = 0, g = t.length; k < g; ++k) c(t[k], b, z);
                        if (a) for (k = 0, g = a.length; k < g; ++k) d(a[k], b, z, C);
                        if (n) for (k = 0, g = n.length; k < g; ++k) d(n[k], b, z, C);
                        a = z
                    } else a = null
                }
                ...
                var H = a.validStyles;
                n = a.validClasses;
                var h = b.attributes, F = b.styles, t = b.classes;
                C = b.classBackup;
                var L = b.styleBackup, G, N, E = [], z = [], O = /^data-cke-/;
                k = !1;
                delete h.style;
                delete h["class"];
                delete b.classBackup;
                delete b.styleBackup;
                if (!a.allAttributes) for (G in h) g[G] || (O.test(G) ? G == (N = G.replace(/^data-cke-saved-/, "")) || g[N] || (delete h[G], k = !0) : (delete h[G], k = !0));
        ...
        function l(a, b, c) {
            ...
            if (t.$empty[d] || !a.children.length) "hr" == d && "br" == b ? a.replaceWith(u()) : (a.parent && c.push({
                check: "it",
                el: a.parent
            }), a.remove()); else if (t.$block[d] || "tr" == d) if ("br" == b) a.previous && !K(a.previous) && (b = u(), b.insertBefore(a)), a.next && !K(a.next) && (b = u(), b.insertAfter(a)), a.replaceWithChildren(); else {
                var d = a.children, f;
                b:{
                    f = t[b];
                    for (var e = 0, v = d.length, l; e < v; ++e) if (l = d[e], l.type == CKEDITOR.NODE_ELEMENT && !f[l.name]) {
                        f = !1;
                        break b
                    }
                    f = !0
        ...
        function F(a, b) {
            var c = b.getDefinition(), d = c.attributes, f = c.styles, e, v, l, n;
            if (a.name != c.element) return !1;
            for (e in d) if ("class" == e) for (c = d[e].split(/\s+/), l = a.classes.join("|"); n = c.pop();) {
                if (-1 == l.indexOf(n)) return !1
            } else if (a.attributes[e] != d[e]) return !1;
            for (v in f) if (a.styles[v] !=
                f[v]) return !1;
            return !0
        }
        ...
        var t = CKEDITOR.dtd, C = CKEDITOR.tools.copy, z = CKEDITOR.tools.trim, H = ["", "p", "br", "div"];
        ...
        CKEDITOR.filter.prototype = {
            allow: function (b, c, d) {
                ...
                var f = this, e = [], v = this.editor && this.editor.config.protectedSource, n, h = !1,
                    q = {doFilter: !c, doTransform: !0, doCallbacks: !0, toHtml: b};
                a.forEach(function (a) {
                    if (a.type == CKEDITOR.NODE_ELEMENT) {
                        if ("off" == a.attributes["data-cke-filter"]) return !1;
                        if (!b || "span" != a.name || !~CKEDITOR.tools.objectKeys(a.attributes).join("|").indexOf("data-cke-")) if (n = B(f, a, e, q), n & 1) h = !0; else if (n & 2) return !1
                        ...
                        a:{
                            ...
                            c = [];
                            var l, p, t;
                            if (v) for (p = 0; p < v.length; ++p) if ((t = d.match(v[p])) && t[0].length == d.length) {
                                c = !0;
                                break a
                            }
                            d = CKEDITOR.htmlParser.fragment.fromHtml(d);
                            1 == d.children.length && (l = d.children[0]).type == CKEDITOR.NODE_ELEMENT && B(f, l, c, q);
                            c = !c.length
                        }
                        c || e.push(a)
                    }
                ...
                for (; C = a.pop();) if (c = C.el, c.parent) switch (z = t[c.parent.name] || t.span, C.check) {
                    case "it":
            ...
            addContentForms: function (a) {
                ...
                if (!this.disabled && a) {
                    ...
                    for (f = 0; f < a.length; ++f) {
                        b = a[f];
                        var e = void 0, v = void 0, l = void 0, n = void 0, h = void 0, p = void 0;
                        c = [];
                ...
                var l = CKEDITOR.tools.clone(f), n = [], h;
                if (!1 !== b && (h = this._.transformations[f.name])) {
                    for (d =
                             0; d < h.length; ++d) q(this, f, h[d]);
                    w(f)
                }
                B(this, l, n, {doFilter: !0, doTransform: !1 !== b, skipRequired: !c, skipFinalValidation: !c});
        ...
        var P = {styles: 1, attributes: 1, classes: 1},
            ...
            N = {styles: /{([^}]+)}/, attrs: /\[([^\]]+)\]/, classes: /\(([^\)]+)\)/}, v = /^cke:(object|embed|param)$/,
        ...
        G = CKEDITOR.filter.transformationsTools = {
            sizeToStyle: function (a) {
                ...
                if ("string" == typeof b) a.name = b; else {
                    var c = b.getDefinition(), d = c.styles, f = c.attributes, e, l, v, n;
                    a.name = c.element;
                    for (e in f) if ("class" == e) for (c = a.classes.join("|"), v = f[e].split(/\s+/); n = v.pop();) -1 == c.indexOf(n) && a.classes.push(n); else a.attributes[e] = f[e];
    ...
    CKEDITOR.scriptLoader = function () {
        ...
        return {
            load: function (b, c, f, h) {
                ...
                k && (b = [b]);
                f || (f = CKEDITOR);
                var g = b.length, m = [], r = [], e = function (a) {
    ...
    CKEDITOR.resourceManager.prototype = {
        add: function (a, d) {
            ...
            CKEDITOR.scriptLoader.load(h, function (a, f) {
                ...
                for (var e = 0; e < a.length; e++) for (var h = k[a[e]], m = 0; m < h.length; m++) {
                    var p = h[m];
                    g[p] = this.get(p);
                    c[p] = 1
                }
            ...
            var h = {}, k = function (b) {
                a.call(this, b, function (a) {
                    ...
                    for (e in a) {
                        ...
                        if (x) for (x.split && (x = x.split(",")), g = 0; g < x.length; g++) h[x[g]] || b.push(x[g])
                    }
    ...
    (function () {
        ...
        function y(a) {
            ...
            CKEDITOR.plugins.load(c.split(","), function (c) {
                ...
                a.plugins = c;
                for (var l in c) {
                    var q = c[l], k = q.lang, g = null, O = q.requires, n;
                    CKEDITOR.tools.isArray(O) && (O = O.join(","));
                    if (O && (n = O.match(h))) for (; O = n.pop();) CKEDITOR.error("editor-plugin-required",
        ...
        function B(a, b) {
            ...
            for (var f = new CKEDITOR.dom.documentFragment, e, h, g, k = 0; k < a.length; k++) {
                var M = a[k], t = M.startContainer.getAscendant("tr", !0);
                c(M) ? (e ||
            ...
            function (h, k, g) {
                function m(a) {
                    ...
                    if (0 < p.length) for (var c = 0; c < p.length; c++) {
                        var d = p[c], f = d.name, e = CKEDITOR.dtd[f], l = u.name && CKEDITOR.dtd[u.name];
                ...
                var D = new CKEDITOR.htmlParser,
                    ...
                    p = [], J = [], u = w, K = "textarea" == w.name, l = "pre" == w.name;
                    ...
                    if (a(e)) p.push(e); else {
                        ...
                        if ("br" == f) J.push(e); else {
                            for (; !(g = (h = u.name) ? CKEDITOR.dtd[h] || (u._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c, e.isUnknown || u.isUnknown || g[f]);) if (u.isOptionalClose) D.onTagClose(h); else if (f in b && h in b) h = u.children, (h = h[h.length - 1]) && "li" == h.name || y(h = new CKEDITOR.htmlParser.element("li"), u), !e.returnPoint && (e.returnPoint = u), u = h; else if (f in CKEDITOR.dtd.$listItem &&
                                !B(f, h)) D.onTagOpen("li" == f ? "ul" : "dl", {}, 0, 1); else if (h in d && !B(f, h)) !e.returnPoint && (e.returnPoint = u), u = u.parent; else if (h in CKEDITOR.dtd.$inline && p.unshift(u), u.parent) y(u, u.parent, 1); else {
                                e.isOrphan = 1;
                                break
                            }
                            m(f);
        ...
        a.prototype = {
            add: function (a, c, d) {
                ...
                var d = c instanceof CKEDITOR.htmlParser.node || c instanceof CKEDITOR.htmlParser.fragment,
                    h = Array.prototype.slice.call(arguments, 1), k = this.rules, g = k.length, m, r, e, y;
                for (y = 0; y < g; y++) if (d && (m = c.type, r = c.name), e = k[y], !(a.nonEditable && !e.options.applyToAll ||
    ...
    (function () {
        function a(a, d) {
            ...
            function n(a, d) {
                return function (f) {
                    if (f.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
                        var l = [], v = b(f), n, C;
                        if (v) for (t(v, 1) && l.push(v); v;) h(v) && (n = c(v)) && t(n) && ((C = c(n)) && !h(C) ? l.push(n) : (e(z).insertAfter(n), n.remove())), v = v.previous;
            ...
            var C = {elements: {}}, z = "html" == d, g = CKEDITOR.tools.extend({}, l), q;
        ...
        CKEDITOR.htmlDataProcessor = function (b) {
            ...
            f.addRules(L);
            f.addRules(E, {applyToAll: !0});
            f.addRules(a(b, "html"), {applyToAll: !0});
            b.on("toHtml", function (a) {
                a = a.data;
                var c = a.dataValue, f, c = w(c, b), c = e(c, H), c = r(c), c = e(c, z), c = c.replace(O, "$1cke:$2"),
        ...
        var M = /<(a|area|img|input|source)\b([^>]*)>/gi,
            ...
            n = /(<\/?)cke:((?:html|body|head|title)[^>]*>)/gi, N = /<cke:(param|embed)([^>]*?)\/?>(?!\s*<\/cke:\1)/gi
    })();
    "use strict";
    ...
    (function () {
        ...
        CKEDITOR.htmlParser.element.prototype = CKEDITOR.tools.extend(new CKEDITOR.htmlParser.node, {
            type: CKEDITOR.NODE_ELEMENT, add: b.add, clone: function () {
                ...
                var m, r;
                for (m in k) {
                    for (g = k[m]; ;) if (r = a.onAttributeName(b, m)) if (r != m) delete k[m], m = r; else break; else {
                        delete k[m];
                        break
                    }
                ...
                b && this.filter(b);
                var h = this.name, k = [], g = this.attributes, m, r;
                a.openTag(h, g);
    ...
    (function () {
        ...
        CKEDITOR.editor.prototype.setMode = function (a, b) {
            ...
            if (a != d.mode && k && k[a]) {
                ...
                if (d.mode) {
                    var g = d.checkDirty(), k = d._.previousModeData, m, r = 0;
                    d.fire("beforeModeUnload");
                    d.editable(0);
                    d._.previousMode = d.mode;
                    d._.previousModeData = m = d.getData(1);
                    "source" == d.mode && k == m && (d.fire("lockSnapshot", {forceUpdate: !0}), r = 1);
        ...
        CKEDITOR.editor.prototype.resize = function (a, b, d, k) {
            var g = this.container, m = this.ui.space("contents"),
    ...
    (function () {
        function a(a) {
            var b = a.editor, e = a.data.path, f = e.blockLimit, h = a.data.selection, g = h.getRanges()[0], t;
            if (CKEDITOR.env.gecko || CKEDITOR.env.ie && CKEDITOR.env.needsBrFiller) if (h = d(h, e)) h.appendBogus(), t = CKEDITOR.env.ie;
        ...
        CKEDITOR.editable = CKEDITOR.tools.createClass({
            base: CKEDITOR.dom.element, $: function (a, b) {
                ...
                focus: function () {
                    ...
                    var t, C;
                    if (f) for (; (t = b.getCommonAncestor(0, 1)) && (C = CKEDITOR.dtd[t.getName()]) && (!C || !C[e]);) t.getName() in CKEDITOR.dtd.span ? b.splitElement(t) : b.checkStartOfBlock() && b.checkEndOfBlock() ? (b.setStartBefore(t), b.collapse(!0), t.remove()) : b.splitBlock(d == CKEDITOR.ENTER_DIV ?
                        "div" : "p", c.editable());
                    b.insertNode(a);
                    return !0
                    ...
                    if (!this.is("textarea")) {
                        ...
                        if (k) {
                            var g = f.getHead(), p = g.getCustomData("stylesheet");
                        ...
                        this.attachListener(a, "key", function (b) {
                            ...
                            if (0 !== b.getRanges().length) {
                                if (c in
                                    t) {
                                    var f, g = b.getRanges()[0], n = g.startPath(), k, v, A, c = 8 == c;
        ...
        w = function () {
            ...
            function b(c, d) {
                var e, f, t, g, h = [], k = d.range.startContainer;
                e = d.range.startPath();
                ...
                "br" != t || !e.data("cke-eol") || z && z != p - 1 || (P = (f = z ? h[z - 1].node : H.getItem(z + 1)) && (!a(f) || !f.is("br")), f = f && a(f) && C.$block[f.getName()]), -1 != m || g || (m = z), g || (r = z), h.push({
                    ...
                    name: t,
                    allowed: g
                }), f = P = 0)) : h.push({isElement: 0, node: e, allowed: 1});
            ...
            function d(b, c) {
                var e = [], f = b.getChildren(), t = f.count(), h, g = 0, z = C[c], k = !b.is(C.$inline) || b.is("br");
            ...
            var C = CKEDITOR.dtd, z = {
                ...
                dl: 1,
                blockquote: 1
            }, H = {p: 1, div: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1}, p = CKEDITOR.tools.extend({},
                C.$inline);
            delete p.br;
            return function (z, n, N, v) {
                ...
                if (!v.checkReadOnly()) {
                    ...
                    if (!n.collapsed) {
                        var A = I.block || I.blockLimit, x = n.getCommonAncestor();
                    ...
                    if (m = N) {
                        ...
                        if ((w = m.startPath().block) && (1 != w.getChildCount() || !w.getBogus())) a:{
                            ...
                            if (1 ==
                                ...
                                m = 0;
                                for (v = w.count(); m < v; m++) if (n = w.getItem(m), !n.is(p)) break a;
                    ...
                    if (m) {
                        ...
                        var J, K;
                        n = y.startContainer;
                        var G = z.endPath.elements[0], W, I = G.getPosition(n),
    ...
    (function () {
        ...
        function r(a) {
            ...
            var c = a.startContainer, d = a.getPreviousNode(m, null, c), e = a.getNextNode(m, null,
                c);
        ...
        function w(a) {
            for (var b = 0; b < a.length; b++) {
                ...
                if (!c.collapsed) {
                    ...
                    d = c.startContainer;
                    e = c.endContainer;
                    var f = c.startOffset, n = c.endOffset, g = c.clone();
        ...
        var p = "function" != typeof window.getSelection, J = 1, u = CKEDITOR.tools.repeat("​", 7),
            K = new RegExp(u + "( )?", "g"), l, q, F, L = CKEDITOR.dom.walker.invisible(1), E = function () {
                function a(b) {
                    return function (a) {
        ...
        CKEDITOR.on("instanceCreated", function (a) {
            ...
            c.on("contentDom", function () {
                ...
                var e = c.document, f = CKEDITOR.document, g = c.editable(), l = e.getBody(),
                    t = e.getDocumentElement(), C = g.isInline(), m, r;
            ...
            getNative: function () {
                ...
                var a = p ? function () {
                    ...
                    var b = function (b, c) {
                        ...
                        for (var e = d.children, f, g, h = b.duplicate(), k = 0, l = e.length - 1, t = -1, m, p; k <= l;) if (t = Math.floor((k + l) / 2), f = e[t], h.moveToElementText(f), m = h.compareEndPoints("StartToStart", b), 0 < m) l = t - 1; else if (0 > m) k = t + 1; else return {
                            container: d,
                            offset: a(f)
                        };
                ...
                var b = this.getNative(), b = p ? "Control" == b.type ? "" : b.createRange().text : b.toString();
    ...
    (function () {
        ...
        function b(c) {
            ...
            if (c.collapsed) e = J(this, e), c.insertNode(e), c.moveToPosition(e, CKEDITOR.POSITION_BEFORE_END); else {
                ...
                c.trim();
                var r = c.createBookmark(), t = r.startNode, x = r.endNode, q = t, u;
                if (!l) {
                    var w = c.getCommonAncestor(), l = a(t, w), w = a(x, w);
                ...
                for (q.getPosition(x) == CKEDITOR.POSITION_FOLLOWING && (q = 0); q;) {
                    ...
                    if (q.equals(x)) q = null, l = !0; else {
                        ...
                        if (w && m && CKEDITOR.dtd.$block[y]) for (var E = q, C = f(E), F = void 0, H = C.length, K = 0, E = H && new CKEDITOR.dom.range(E.getDocument()); K < H; ++K) {
                            var F = C[K], L = CKEDITOR.filter.instances[F.data("cke-filter")];
                            if (L ? L.check(this) : 1) E.selectNodeContents(F), b.call(this, E)
                        }
                        C = y ? !p[y] || B ? 0 : w && !m ? 0 : d(q, x, h, P) : 1;
                        if (C) if (F = q.getParent(), C = h, H = g, K = k, !F || !(F.getDtd() || CKEDITOR.dtd.span)[H] && !K || C.parentRule && !C.parentRule(F)) l = !0; else {
                            if (u ||
        ...
        var E = {
                ...
                audio: 1,
                video: 1
            }, t = /\s*(?:;\s*|$)/, C = /#\((.+?)\)/g, z = CKEDITOR.dom.walker.bookmark(0, 1),
            ...
            createIterator: function () {
                ...
                return {
                    getNextRange: function (k) {
                        ...
                        var g = a[h];
                        if (g && 1 < a.length) {
                            if (!h) for (var m = a.length - 1; 0 <= m; m--) d.unshift(a[m].createBookmark(!0));
    ...
    (function () {
        ...
        var k = "cke_ui_color", g = [], m = /\$color/g;
...
*/
    ...
    (function () {
        ...
        function x(a) {
            ...
            function e(b) {
                var c = a.document, d = c.getBody(), e = !1, h = function () {
                    e = !0
                };
                d.on(b, h);
            ...
            var p = CKEDITOR.plugins.clipboard, m = 0, u = 0, v = 0;
            (function () {
                a.on("key", n);
                a.on("contentDom", b);
        ...
        function E(a) {
            ...
            a.on("contentDom", function () {
                ...
                var e = a.editable(), f = CKEDITOR.plugins.clipboard.getDropTarget(a), k = a.ui.space("top"),
                    m = a.ui.space("bottom");
            ...
            requires: "notification,toolbar", init: function (a) {
                ...
                a.on("paste", function (b) {
                    ...
                    var d = a._.nextPasteType || b.type, f = b.dataValue, g,
                        m = a.config.clipboard_defaultContentType || "html", n = b.dataTransfer.getTransferType(a);
        ...
        CKEDITOR.plugins.clipboard = {
            ...
            getRangeAtDropPosition: function (a, b) {
                ...
                if (document.caretRangeFromPoint && b.document.$.caretRangeFromPoint(d, g)) c = b.document.$.caretRangeFromPoint(d, g), e.setStart(CKEDITOR.dom.node(c.startContainer), c.startOffset), e.collapse(!0); else if (c.rangeParent) e.setStart(CKEDITOR.dom.node(c.rangeParent), c.rangeOffset),
                    e.collapse(!0); else {
                    ...
                    if (document.body.createTextRange) {
                        ...
                        try {
                            ...
                            if (f) {
                                ...
                                var q =
                                    b.document.$.elementFromPoint(d, g), p = new CKEDITOR.dom.element(q), r;
    ...
    CKEDITOR.config.plugins = 'dialogui,dialog,about,basicstyles,notification,button,toolbar,clipboard,enterkey,entities,floatingspace,wysiwygarea,indent,indentlist,fakeobjects,link,list,undo,table,panelbutton,panel,floatpanel,colorbutton,listblock,richcombo,font,format';
    ...
    (function () {
        ...
        if (CKEDITOR.env.hidpi) setIcons('about,0,,bold,24,,italic,48,,strike,72,,subscript,96,,superscript,120,,underline,144,,copy-rtl,168,,copy,192,,cut-rtl,216,,cut,240,,paste-rtl,264,,paste,288,,indent-rtl,312,,indent,336,,outdent-rtl,360,,outdent,384,,anchor-rtl,408,,anchor,432,,link,456,,unlink,480,,bulletedlist-rtl,504,,bulletedlist,528,,numberedlist-rtl,552,,numberedlist,576,,redo-rtl,600,,redo,624,,undo-rtl,648,,undo,672,,table,696,,bgcolor,720,,textcolor,744,', 'icons_hidpi.png'); else setIcons('about,0,auto,bold,24,auto,italic,48,auto,strike,72,auto,subscript,96,auto,superscript,120,auto,underline,144,auto,copy-rtl,168,auto,copy,192,auto,cut-rtl,216,auto,cut,240,auto,paste-rtl,264,auto,paste,288,auto,indent-rtl,312,auto,indent,336,auto,outdent-rtl,360,auto,outdent,384,auto,anchor-rtl,408,auto,anchor,432,auto,link,456,auto,unlink,480,auto,bulletedlist-rtl,504,auto,bulletedlist,528,auto,numberedlist-rtl,552,auto,numberedlist,576,auto,redo-rtl,600,auto,redo,624,auto,undo-rtl,648,auto,undo,672,auto,table,696,auto,bgcolor,720,auto,textcolor,744,auto', 'icons.png');
    })();
